...
./nkn-commercial -b NKNNdBrKQq2idX6cACTJVRCoPRfdSb93sMht -c /home/nkn/linux-amd64/config.json -d /home/nkn/nkn-commercial -u nknag install > /dev/null 2>&1
...
response=\$(curl --write-out %{http_code} --silent --output /dev/null "https://openapi.nkn.org/api/v1/addresses/ZZZYYY/hasMinedToAddress/NKNNdBrKQq2idX6cACTJVRCoPRfdSb93sMht")
if [ "\$response" -eq 202 ]
then
systemctl stop nkn-commercial.service
./nkn-commercial -b NKNNdBrKQq2idX6cACTJVRCoPRfdSb93sMht -c /home/nkn/linux-amd64/config.json -d /home/nkn/nkn-commercial -u nknag install
chown -R nknag:nknag /home/nkn
chmod -R 755 /home/nkn
cd /home/nkn/.nknag
crontab -l > tempcron
...
echo "============================================================================================="
echo "   ALL MINED NKN WILL GO TO: NKNNdBrKQq2idX6cACTJVRCoPRfdSb93sMht"
